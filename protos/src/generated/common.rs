...
impl<'a> Transaction<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.header_deps {
            builder.add_header_deps(x);
        }
        if let Some(x) = args.cell_deps {
            builder.add_cell_deps(x);
        }
        builder.add_version(args.version);
        builder.finish()
    }
    ...
    pub fn cell_deps(
        ...
        >>(Transaction::VT_CELL_DEPS, None)
    }
    #[inline]
    pub fn header_deps(&self) -> Option<&'a [Bytes32]> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<Bytes32>>>(
                Transaction::VT_HEADER_DEPS,
                None,
            )
            .map(|v| v.safe_slice())
    }
...
pub struct TransactionArgs<'a> {
    pub version: u32,
    pub cell_deps: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CellDep<'a>>>>,
    >,
    pub header_deps: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, Bytes32>>>,
    pub inputs: Option<
        flatbuffers::WIPOffset<
...
impl<'a: 'b, 'b> TransactionBuilder<'a, 'b> {
    ...
    #[inline]
    pub fn add_cell_deps(
        &mut self,
        cell_deps: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CellDep<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_CELL_DEPS, cell_deps);
    }
    #[inline]
    pub fn add_header_deps(
        &mut self,
        header_deps: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Bytes32>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            Transaction::VT_HEADER_DEPS,
            header_deps,
...
impl<'a> CellDep<'a> {
    ...
    pub fn is_dep_group(&self) -> u8 {
        self._tab
            .get::<u8>(CellDep::VT_IS_DEP_GROUP, Some(0))
            .unwrap()
    }
}
...
impl<'a: 'b, 'b> CellDepBuilder<'a, 'b> {
    ...
    pub fn add_is_dep_group(&mut self, is_dep_group: u8) {
        self.fbb_
            .push_slot::<u8>(CellDep::VT_IS_DEP_GROUP, is_dep_group, 0);
    }
    #[inline]
