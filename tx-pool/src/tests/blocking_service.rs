...
/// Observe the real verification-control channel in cross-crate ordering tests.
pub fn verification_commands(
    controller: &crate::TxPoolController,
) -> tokio::sync::watch::Receiver<ckb_script::ChunkCommand> {
    controller.verification_command.subscribe()
}
