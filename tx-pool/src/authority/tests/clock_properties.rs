use super::super::{
    ...
    state::{
        ApplyOwnerBatchReservationError, ApplySequence, Arrival, AuthorityClockBank,
        AuthorityClocks, EntryVersion,
    },
};
...
fn uak_batched_apply_clock_reservation_is_all_or_none_at_counter_boundaries() {
    ...
    assert_eq!(
        ...
        .err(),
        Some(ApplyOwnerBatchReservationError::Exhausted)
    );
    ...
    assert_eq!(
        ...
        .err(),
        Some(ApplyOwnerBatchReservationError::StaleBase)
    );
