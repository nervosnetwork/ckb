...
#[expect(
    ...
    reason = "the exact retry cut is a fixed stack value carried across one template attempt; boxing would add an allocator failure and remove Copy from every retry arm"
)]
