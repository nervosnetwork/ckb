...
| 89 | Partial | The isolated `PipelineCoordinator` now owns one entry/incarnation/revision and audits entry↔index↔physical-ticket equality. Deadline, accepted-input and source-promotion transitions plus a 4,000-step state-machine audit are covered; bounded cascade, unwind and production differential coverage remain. | I1, I4 |
