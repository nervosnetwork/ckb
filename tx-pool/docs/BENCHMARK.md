...
rule. Timing cannot weaken any earlier hard constraint.
...
The registry also records cursor-free queue-stage and writer-preferred
fairness-stage wait/hold lifetimes. Ready-only stages deliberately bypass that
gate and therefore emit no scheduler-gate coordinate.
