...
- `resolution_evidence_requires_chain_provenance` (T6, T8)
- `resolution_evidence_skips_same_tip_chain_revalidation` (T6, T8)
- `resolution_evidence_yields_to_pool_spends_and_tip_changes` (T6, T9)
