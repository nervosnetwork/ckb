...
use super::types::{PoolEntry, ProposedEntry, TxPoolConfig};
...
impl TxPool {
    ...
    pub(crate) fn add_proposed(
        ...
        self.proposed.add_tx(cycles, tx, fee, proposer);
    }
    ...
    pub fn get_entry(&self, id: &ProposalShortId) -> Option<(Transaction, Option<Cycle>)> {
        self.pending
            .get(id)
