...
use rocksdb::ops::{
    CreateCf, DeleteFileInRangeCF, DropCf, GetColumnFamilys, GetPinned, GetPinnedCF, IterateCF,
    OpenCF, Put, SetOptions, WriteOps,
};
use rocksdb::{
...
impl RocksDB {
    ...
    pub fn get_pinned_defalt(&self, key: &[u8]) -> Result<Option<DBPinnableSlice>> {
