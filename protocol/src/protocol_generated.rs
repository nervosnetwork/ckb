...
pub mod ckb {
    ...
    pub mod protocol {
        ...
        const ENUM_NAMES_SYNC_PAYLOAD: [&'static str; 5] =
            ["NONE", "GetHeaders", "Headers", "GetBlocks", "Block"];
        ...
        impl<'a> SyncMessage<'a> {
            ...
            #[inline]
            pub fn payload_type(&'a self) -> SyncPayload {
                self._tab
                    .get::<SyncPayload>(SyncMessage::VT_PAYLOAD_TYPE, Some(SyncPayload::NONE))
                    .unwrap()
            }
            #[inline]
            pub fn payload(&'a self) -> Option<flatbuffers::Table<'a>> {
                self._tab
        ...
        impl<'a> GetHeaders<'a> {
            ...
            #[inline]
            pub fn block_locator_hashes(&'a self) -> Option<&'a [u8]> {
                self._tab
            ...
            #[inline]
            pub fn hash_stop(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
        ...
        pub struct GetHeadersArgs<'a> {
            pub version: u32,
            pub block_locator_hashes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
        ...
        impl<'a: 'b, 'b> GetHeadersBuilder<'a, 'b> {
            ...
            pub fn add_block_locator_hashes(
                &mut self,
                block_locator_hashes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    GetHeaders::VT_BLOCK_LOCATOR_HASHES,
        ...
        impl<'a> GetBlocks<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                GetBlocks { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args GetBlocksArgs<'args>,
            ) -> flatbuffers::WIPOffset<GetBlocks<'bldr>> {
                let mut builder = GetBlocksBuilder::new(_fbb);
                if let Some(x) = args.block_hashes {
                    builder.add_block_hashes(x);
                }
                builder.finish()
            }
            ...
            #[inline]
            pub fn block_hashes(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        GetBlocks::VT_BLOCK_HASHES,
                        None,
                    ).map(|v| v.safe_slice())
            }
        }
        ...
        pub struct GetBlocksArgs<'a> {
            pub block_hashes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
        }
        impl<'a> Default for GetBlocksArgs<'a> {
            #[inline]
            fn default() -> Self {
                GetBlocksArgs { block_hashes: None }
            }
        }
        ...
        impl<'a: 'b, 'b> GetBlocksBuilder<'a, 'b> {
            #[inline]
            pub fn add_block_hashes(
                &mut self,
                block_hashes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    GetBlocks::VT_BLOCK_HASHES,
                    block_hashes,
        ...
        impl<'a> Headers<'a> {
            ...
            pub fn headers(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Header<'a>>>> {
        ...
        impl<'a> Header<'a> {
            ...
            #[inline]
            pub fn parent_hash(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
            ...
            #[inline]
            pub fn number(&'a self) -> u64 {
                self._tab.get::<u64>(Header::VT_NUMBER, Some(0)).unwrap()
            }
            #[inline]
            pub fn txs_commit(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
            ...
            #[inline]
            pub fn txs_proposal(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
            ...
            #[inline]
            pub fn difficulty(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
            ...
            #[inline]
            pub fn proof(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        Header::VT_PROOF,
                        None,
            ...
            #[inline]
            pub fn cellbase_id(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
            ...
            #[inline]
            pub fn uncles_hash(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
        ...
        impl<'a: 'b, 'b> HeaderBuilder<'a, 'b> {
            ...
            pub fn add_proof(
                &mut self,
                proof: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_
        ...
        impl<'a> Block<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.proposal_transactions {
                    builder.add_proposal_transactions(x);
                }
                if let Some(x) = args.commit_transactions {
                    builder.add_commit_transactions(x);
                }
            ...
            pub fn uncles(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<UncleBlock<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
            ...
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Transaction<'a>>>>
            {
                ...
                >>(Block::VT_COMMIT_TRANSACTIONS, None)
            }
            #[inline]
            pub fn proposal_transactions(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        Block::VT_PROPOSAL_TRANSACTIONS,
                        None,
                    ).map(|v| v.safe_slice())
            }
        }
        ...
        pub struct BlockArgs<'a> {
            ...
            pub uncles: Option<
                ...
                >,
            >,
            pub commit_transactions: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transaction<'a>>>,
                >,
            >,
            pub proposal_transactions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
        }
        ...
        impl<'a: 'b, 'b> BlockBuilder<'a, 'b> {
            ...
            #[inline]
            pub fn add_commit_transactions(
                &mut self,
                commit_transactions: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Transaction<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Block::VT_COMMIT_TRANSACTIONS,
                    commit_transactions,
                );
            }
            #[inline]
            pub fn add_proposal_transactions(
                &mut self,
                proposal_transactions: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Block::VT_PROPOSAL_TRANSACTIONS,
        ...
        impl<'a> UncleBlock<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.cellbase {
                    builder.add_cellbase(x);
                }
                if let Some(x) = args.header {
                    builder.add_header(x);
                }
            ...
            #[inline]
            pub fn cellbase(&'a self) -> Option<Transaction<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Transaction<'a>>>(
                        UncleBlock::VT_CELLBASE,
                        None,
                    )
            }
            #[inline]
            pub fn proposal_transactions(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        UncleBlock::VT_PROPOSAL_TRANSACTIONS,
                        None,
                    ).map(|v| v.safe_slice())
            }
        }
        ...
        impl<'a> Transaction<'a> {
            ...
            pub fn deps(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<OutPoint<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
        ...
        pub struct TransactionArgs<'a> {
            ...
            pub deps: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<OutPoint<'a>>>,
                >,
            >,
            pub inputs: Option<
                flatbuffers::WIPOffset<
        ...
        impl<'a> OutPoint<'a> {
            ...
            #[inline]
            pub fn hash(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        OutPoint::VT_HASH,
                        None,
        ...
        impl<'a> CellInput<'a> {
            ...
            #[inline]
            pub fn unlock(&'a self) -> Option<Script<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Script<'a>>>(CellInput::VT_UNLOCK, None)
            }
        }
        ...
        impl<'a: 'b, 'b> CellInputBuilder<'a, 'b> {
            ...
            pub fn add_unlock(&mut self, unlock: flatbuffers::WIPOffset<Script<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<Script>>(
                        CellInput::VT_UNLOCK,
                        unlock,
                    );
            }
        ...
        impl<'a> CellOutput<'a> {
            ...
            #[inline]
            pub fn lock(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        CellOutput::VT_LOCK,
                        None,
        ...
        impl<'a> Script<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.redeem_arguments {
                    builder.add_redeem_arguments(x);
                }
                if let Some(x) = args.redeem_reference {
                    builder.add_redeem_reference(x);
                }
                if let Some(x) = args.redeem_script {
                    builder.add_redeem_script(x);
                }
            ...
            pub const VT_REDEEM_SCRIPT: flatbuffers::VOffsetT = 8;
            pub const VT_REDEEM_REFERENCE: flatbuffers::VOffsetT = 10;
            pub const VT_REDEEM_ARGUMENTS: flatbuffers::VOffsetT = 12;
            ...
            pub fn arguments(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Argument<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Argument<'a>>>,
                >>(Script::VT_ARGUMENTS, None)
            }
            #[inline]
            pub fn redeem_script(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        Script::VT_REDEEM_SCRIPT,
                        None,
                    ).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn redeem_reference(&'a self) -> Option<OutPoint<'a>> {
                self._tab.get::<flatbuffers::ForwardsUOffset<OutPoint<'a>>>(
                    Script::VT_REDEEM_REFERENCE,
                    None,
                )
            }
            #[inline]
            pub fn redeem_arguments(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Argument<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Argument<'a>>>,
                >>(Script::VT_REDEEM_ARGUMENTS, None)
            }
        }
        ...
        pub struct ScriptArgs<'a> {
            ...
            pub arguments: Option<
                ...
                >,
            >,
            pub redeem_script: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
            pub redeem_reference: Option<flatbuffers::WIPOffset<OutPoint<'a>>>,
            pub redeem_arguments: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Argument<'a>>>,
                >,
            >,
        ...
        impl<'a> Default for ScriptArgs<'a> {
            ...
            fn default() -> Self {
                ScriptArgs {
                    ...
                    arguments: None,
                    redeem_script: None,
                    redeem_reference: None,
                    redeem_arguments: None,
                }
            }
        }
        ...
        impl<'a: 'b, 'b> ScriptBuilder<'a, 'b> {
            ...
            pub fn add_arguments(
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Script::VT_ARGUMENTS, arguments);
            }
            #[inline]
            pub fn add_redeem_script(
                &mut self,
                redeem_script: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Script::VT_REDEEM_SCRIPT,
                    redeem_script,
            ...
            #[inline]
            pub fn add_redeem_reference(
                &mut self,
                redeem_reference: flatbuffers::WIPOffset<OutPoint<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<OutPoint>>(
                        Script::VT_REDEEM_REFERENCE,
                        redeem_reference,
                    );
            }
            #[inline]
            pub fn add_redeem_arguments(
                &mut self,
                redeem_arguments: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Argument<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Script::VT_REDEEM_ARGUMENTS,
                    redeem_arguments,
                );
            }
            #[inline]
        ...
        impl<'a: 'b, 'b> ArgumentBuilder<'a, 'b> {
            ...
            pub fn add_value(
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Argument::VT_VALUE, value);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ...
        impl<'a> RelayMessage<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                RelayMessage { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args RelayMessageArgs,
            ) -> flatbuffers::WIPOffset<RelayMessage<'bldr>> {
            ...
            #[inline]
            pub fn payload_type(&'a self) -> RelayPayload {
                self._tab
                    .get::<RelayPayload>(RelayMessage::VT_PAYLOAD_TYPE, Some(RelayPayload::NONE))
                    .unwrap()
            }
            #[inline]
            pub fn payload(&'a self) -> Option<flatbuffers::Table<'a>> {
            ...
            pub fn payload_as_get_block_transactions(&'a self) -> Option<GetBlockTransactions> {
                if self.payload_type() == RelayPayload::GetBlockTransactions {
                    self.payload()
                        .map(|u| GetBlockTransactions::init_from_table(u))
                } else {
                    None
                }
            }
            ...
            pub fn payload_as_block_transactions(&'a self) -> Option<BlockTransactions> {
                if self.payload_type() == RelayPayload::BlockTransactions {
                    self.payload()
                        .map(|u| BlockTransactions::init_from_table(u))
                } else {
                    None
                }
            }
        ...
        impl<'a: 'b, 'b> RelayMessageBuilder<'a, 'b> {
            ...
            pub fn add_payload_type(&mut self, payload_type: RelayPayload) {
                self.fbb_.push_slot::<RelayPayload>(
                    RelayMessage::VT_PAYLOAD_TYPE,
                    payload_type,
                    RelayPayload::NONE,
                );
            }
        ...
        impl<'a> CompactBlock<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                CompactBlock { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args CompactBlockArgs<'args>,
            ) -> flatbuffers::WIPOffset<CompactBlock<'bldr>> {
                ...
                if let Some(x) = args.prefilled_transactions {
                    builder.add_prefilled_transactions(x);
                }
                if let Some(x) = args.short_ids {
                    builder.add_short_ids(x);
                }
                if let Some(x) = args.header {
                    builder.add_header(x);
                }
            ...
            pub fn header(&'a self) -> Option<Header<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Header<'a>>>(CompactBlock::VT_HEADER, None)
            }
            #[inline]
            pub fn nonce(&'a self) -> u64 {
                self._tab
                    .get::<u64>(CompactBlock::VT_NONCE, Some(0))
                    .unwrap()
            }
            #[inline]
            pub fn short_ids(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        CompactBlock::VT_SHORT_IDS,
                        None,
                    ).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn prefilled_transactions(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<PrefilledTransaction<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<PrefilledTransaction<'a>>>,
                >>(CompactBlock::VT_PREFILLED_TRANSACTIONS, None)
            }
            #[inline]
            pub fn uncles(
                &'a self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<UncleBlock<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<UncleBlock<'a>>>,
                >>(CompactBlock::VT_UNCLES, None)
            }
            #[inline]
            pub fn proposal_transactions(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        CompactBlock::VT_PROPOSAL_TRANSACTIONS,
                        None,
                    ).map(|v| v.safe_slice())
            }
        }
        ...
        pub struct CompactBlockArgs<'a> {
            pub header: Option<flatbuffers::WIPOffset<Header<'a>>>,
            pub nonce: u64,
            pub short_ids: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
            pub prefilled_transactions: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PrefilledTransaction<'a>>>,
                >,
            >,
            pub uncles: Option<
                flatbuffers::WIPOffset<
        ...
        impl<'a: 'b, 'b> CompactBlockBuilder<'a, 'b> {
            ...
            #[inline]
            pub fn add_short_ids(
                &mut self,
                short_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    CompactBlock::VT_SHORT_IDS,
                    short_ids,
            ...
            #[inline]
            pub fn add_prefilled_transactions(
                &mut self,
                prefilled_transactions: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PrefilledTransaction<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    CompactBlock::VT_PREFILLED_TRANSACTIONS,
            ...
            pub fn add_uncles(
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(CompactBlock::VT_UNCLES, uncles);
            }
            #[inline]
            pub fn add_proposal_transactions(
                &mut self,
        ...
        impl<'a> PrefilledTransaction<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                PrefilledTransaction { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args PrefilledTransactionArgs<'args>,
            ) -> flatbuffers::WIPOffset<PrefilledTransaction<'bldr>> {
            ...
            pub fn index(&'a self) -> u32 {
                self._tab
                    .get::<u32>(PrefilledTransaction::VT_INDEX, Some(0))
                    .unwrap()
            }
            #[inline]
            pub fn transaction(&'a self) -> Option<Transaction<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Transaction<'a>>>(
                        PrefilledTransaction::VT_TRANSACTION,
                        None,
                    )
            }
        }
        ...
        impl<'a: 'b, 'b> PrefilledTransactionBuilder<'a, 'b> {
            ...
            pub fn add_index(&mut self, index: u32) {
                self.fbb_
                    .push_slot::<u32>(PrefilledTransaction::VT_INDEX, index, 0);
            }
            #[inline]
            pub fn add_transaction(
                &mut self,
                transaction: flatbuffers::WIPOffset<Transaction<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<Transaction>>(
                        PrefilledTransaction::VT_TRANSACTION,
            ...
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> PrefilledTransactionBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl<'a> GetBlockTransactions<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                GetBlockTransactions { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args GetBlockTransactionsArgs<'args>,
            ) -> flatbuffers::WIPOffset<GetBlockTransactions<'bldr>> {
            ...
            pub fn hash(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        GetBlockTransactions::VT_HASH,
                        None,
                    ).map(|v| v.safe_slice())
            }
            #[inline]
            pub fn indexes(&'a self) -> Option<flatbuffers::Vector<'a, u32>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                        GetBlockTransactions::VT_INDEXES,
                        None,
                    )
            }
        }
        ...
        impl<'a: 'b, 'b> GetBlockTransactionsBuilder<'a, 'b> {
            ...
            pub fn add_indexes(
                &mut self,
                indexes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    GetBlockTransactions::VT_INDEXES,
                    indexes,
            ...
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> GetBlockTransactionsBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl<'a> GetBlockProposal<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                GetBlockProposal { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args GetBlockProposalArgs<'args>,
            ) -> flatbuffers::WIPOffset<GetBlockProposal<'bldr>> {
            ...
            #[inline]
            pub fn block_number(&'a self) -> u64 {
                self._tab
                    .get::<u64>(GetBlockProposal::VT_BLOCK_NUMBER, Some(0))
                    .unwrap()
            }
            #[inline]
            pub fn proposal_transactions(&'a self) -> Option<&'a [u8]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        GetBlockProposal::VT_PROPOSAL_TRANSACTIONS,
                        None,
                    ).map(|v| v.safe_slice())
            }
        }
        ...
        impl<'a: 'b, 'b> GetBlockProposalBuilder<'a, 'b> {
            ...
            pub fn add_block_number(&mut self, block_number: u64) {
                self.fbb_
                    .push_slot::<u64>(GetBlockProposal::VT_BLOCK_NUMBER, block_number, 0);
            }
            #[inline]
            pub fn add_proposal_transactions(
                &mut self,
        ...
        impl<'a> BlockProposal<'a> {
            #[inline]
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                BlockProposal { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args BlockProposalArgs<'args>,
            ) -> flatbuffers::WIPOffset<BlockProposal<'bldr>> {
            ...
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Transaction<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Transaction<'a>>>,
                >>(BlockProposal::VT_TRANSACTIONS, None)
            }
        }
        ...
        impl<'a> Default for BlockProposalArgs<'a> {
            #[inline]
            fn default() -> Self {
                BlockProposalArgs { transactions: None }
            }
        }
        ...
        #[inline]
        pub fn finish_size_prefixed_sync_message_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<SyncMessage<'a>>,
        ) {
