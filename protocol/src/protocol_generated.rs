...
impl<'a> Transaction<'a> {
  ...
  #[inline]
  pub fn deps(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CellDep<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<CellDep<'a>>>>>(Transaction::VT_DEPS, None)
  }
  #[inline]
...
pub struct TransactionArgs<'a> {
    pub version: u32,
    pub deps: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<CellDep<'a >>>>>,
...
impl<'a: 'b, 'b> TransactionBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_deps(&mut self, deps: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<CellDep<'b >>>>) {
...
impl<'a> CellDep<'a> {
  ...
  pub fn block_hash(&self) -> Option<&'a H256> {
    self._tab.get::<H256>(CellDep::VT_BLOCK_HASH, None)
  }
  #[inline]
...
impl<'a: 'b, 'b> CellDepBuilder<'a, 'b> {
  ...
  pub fn add_block_hash(&mut self, block_hash: &'b  H256) {
    self.fbb_.push_slot_always::<&H256>(CellDep::VT_BLOCK_HASH, block_hash);
  }
  #[inline]
