...
impl<'a> Header<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.proposals_root { builder.add_proposals_root(x); }
    ...
    pub const VT_PROPOSALS_ROOT: flatbuffers::VOffsetT = 14;
  ...
  #[inline]
  pub fn proposals_root(&self) -> Option<&'a H256> {
    self._tab.get::<H256>(Header::VT_PROPOSALS_ROOT, None)
  }
  #[inline]
...
pub struct HeaderArgs<'a> {
    ...
    pub proposals_root: Option<&'a  H256>,
...
impl<'a: 'b, 'b> HeaderBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_proposals_root(&mut self, proposals_root: &'b  H256) {
    self.fbb_.push_slot_always::<&H256>(Header::VT_PROPOSALS_ROOT, proposals_root);
  }
  #[inline]
