...
impl<'a> Script<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.redeem_arguments { builder.add_redeem_arguments(x); }
      if let Some(x) = args.redeem_reference { builder.add_redeem_reference(x); }
      if let Some(x) = args.redeem_script { builder.add_redeem_script(x); }
  ...
  #[inline]
  pub fn arguments(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Bytes<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Bytes<'a>>>>>(Script::VT_ARGUMENTS, None)
  }
  #[inline]
  pub fn redeem_script(&self) -> Option<Bytes<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Bytes<'a>>>(Script::VT_REDEEM_SCRIPT, None)
  }
  #[inline]
  pub fn redeem_reference(&self) -> Option<OutPoint<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<OutPoint<'a>>>(Script::VT_REDEEM_REFERENCE, None)
  }
  #[inline]
  pub fn redeem_arguments(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Bytes<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Bytes<'a>>>>>(Script::VT_REDEEM_ARGUMENTS, None)
  }
}

pub struct ScriptArgs<'a> {
    pub version: u8,
    pub arguments: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<Bytes<'a >>>>>,
    pub redeem_script: Option<flatbuffers::WIPOffset<Bytes<'a >>>,
    pub redeem_reference: Option<flatbuffers::WIPOffset<OutPoint<'a >>>,
    pub redeem_arguments: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<Bytes<'a >>>>>,
}
...
impl<'a: 'b, 'b> ScriptBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_arguments(&mut self, arguments: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Bytes<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Script::VT_ARGUMENTS, arguments);
  }
  #[inline]
  pub fn add_redeem_script(&mut self, redeem_script: flatbuffers::WIPOffset<Bytes<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Bytes>>(Script::VT_REDEEM_SCRIPT, redeem_script);
  }
  #[inline]
  pub fn add_redeem_reference(&mut self, redeem_reference: flatbuffers::WIPOffset<OutPoint<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<OutPoint>>(Script::VT_REDEEM_REFERENCE, redeem_reference);
  }
  #[inline]
  pub fn add_redeem_arguments(&mut self, redeem_arguments: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Bytes<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Script::VT_REDEEM_ARGUMENTS, redeem_arguments);
  }
  #[inline]
