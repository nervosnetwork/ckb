...
pub struct ChainSpec {
    ...
    pub pow: Pow,
    #[serde(skip)]
    /// Hash of blake2b_256 spec content bytes, used for check consistency between database and
    /// config
...
impl Params {
    ...
    /// Return the `primary_epoch_reward_halving_interval`, otherwise if None, returns the default
    /// value
