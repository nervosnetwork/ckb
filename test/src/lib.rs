...
fn all_specs() -> Vec<Box<dyn Spec>> {
    let mut specs: Vec<Box<dyn Spec>> = vec![
        ...
        Box::new(LocalTestSubmissionQueuesVerification),
        ...
        Box::new(IndexerPoolRecovery),
        Box::new(RichIndexerPoolRecovery),
        ...
        Box::new(NetworkVerificationTimeBudget),
