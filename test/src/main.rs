...
fn main() {
    ...
    if let Some(spec_name) = env::args().nth(3) {
        let spec: Box<Spec> = match &spec_name[..] {
            ...
            "chain_fork_3" => Box::new(ChainFork3),
            "chain_fork_4" => Box::new(ChainFork4),
            "chain_fork_5" => Box::new(ChainFork5),
            "chain_fork_6" => Box::new(ChainFork6),
            "chain_fork_7" => Box::new(ChainFork7),
