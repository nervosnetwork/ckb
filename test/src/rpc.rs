...
use ckb_jsonrpc_types::{
    ...
    TransactionWithStatus, TxPoolInfo, Uint32, Uint64, VariantTransactionWithStatus, Version,
};
use ckb_types::core::{
...
impl RpcClient {
    ...
    pub fn get_transaction(&self, hash: Byte32) -> Option<TransactionWithStatus> {
        self.inner
            .get_transaction(hash.unpack(), Some(2u32.into()))
            .expect("rpc call get_transaction")
            .map(|v| match v {
                VariantTransactionWithStatus::TransactionWithStatus(ts) => ts,
                _ => panic!("expect ckb_jsonrpc_types::TransactionWithStatus"),
            })
    }
    ...
    pub fn get_transaction_with_verbosity(
        ...
        hash: Byte32,
        verbosity: u32,
    ) -> Option<VariantTransactionWithStatus> {
        self.inner
...
jsonrpc!(pub struct Inner {
    ...
    pub fn get_transaction(&self, _hash: H256, verbosity: Option<Uint32>) -> Option<VariantTransactionWithStatus>;
