...
CREATE INDEX "index_tx_table_tx_hash" ON "ckb_transaction" USING HASH ("tx_hash");

CREATE INDEX "index_input_table_out_point" ON "input" USING HASH ("out_point");

CREATE INDEX "index_output_table_out_point" ON "output" USING HASH ("out_point");
CREATE INDEX "index_output_table_lock" ON "output" USING HASH ("lock_script_hash");
