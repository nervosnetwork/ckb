...
impl SyncMessage {
    ...
    pub fn to_enum(&self) -> SyncMessageUnion {
        ...
        match self.item_id() {
            ...
            4 => InIBD::new_unchecked(inner).into(),
            _ => panic!("{}: invalid data", Self::NAME),
        }
    }
...
impl<'r> SyncMessageReader<'r> {
    ...
    pub fn to_enum(&self) -> SyncMessageUnionReader<'r> {
        ...
        match self.item_id() {
            ...
            4 => InIBDReader::new_unchecked(inner).into(),
            _ => panic!("{}: invalid data", Self::NAME),
        }
    }
}
impl<'r> molecule::prelude::Reader<'r> for SyncMessageReader<'r> {
    ...
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        match item_id {
            ...
            4 => InIBDReader::verify(inner_slice, compatible),
            _ => ve!(Self, UnknownItem, Self::ITEMS_COUNT, item_id),
        }?;
        Ok(())
    }
...
impl<'r> SyncMessageUnionReader<'r> {
    ...
    pub fn item_id(&self) -> molecule::Number {
        match self {
            ...
            SyncMessageUnionReader::InIBD(_) => 4,
        }
    }
    pub fn item_name(&self) -> &str {
        match self {
