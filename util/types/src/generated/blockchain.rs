...
#[derive(Clone)]
pub struct ArchivedBlock(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for ArchivedBlock {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for ArchivedBlock {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for ArchivedBlock {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "uncles", self.uncles())?;
        write!(f, ", {}: {}", "transactions", self.transactions())?;
...
impl ::core::default::Default for ArchivedBlock {
    fn default() -> Self {
        let v: Vec<u8> = vec![
            28, 0, 0, 0, 16, 0, 0, 0, 20, 0, 0, 0, 24, 0, 0, 0, 4, 0, 0, 0, 4, 0, 0, 0, 0, 0, 0, 0,
        ];
        ArchivedBlock::new_unchecked(v.into())
    }
}
impl ArchivedBlock {
    pub const FIELD_COUNT: usize = 3;
    ...
    pub fn as_reader<'r>(&'r self) -> ArchivedBlockReader<'r> {
        ArchivedBlockReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for ArchivedBlock {
    type Builder = ArchivedBlockBuilder;
    const NAME: &'static str = "ArchivedBlock";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        ArchivedBlock(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ArchivedBlockReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ArchivedBlockReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
...
#[derive(Clone, Copy)]
pub struct ArchivedBlockReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for ArchivedBlockReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for ArchivedBlockReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for ArchivedBlockReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "uncles", self.uncles())?;
        write!(f, ", {}: {}", "transactions", self.transactions())?;
...
impl<'r> molecule::prelude::Reader<'r> for ArchivedBlockReader<'r> {
    type Entity = ArchivedBlock;
    const NAME: &'static str = "ArchivedBlockReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        ArchivedBlockReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        UncleBlockVecReader::verify(&slice[offsets[0]..offsets[1]], compatible)?;
        TransactionVecReader::verify(&slice[offsets[1]..offsets[2]], compatible)?;
        ProposalShortIdVecReader::verify(&slice[offsets[2]..offsets[3]], compatible)?;
        Ok(())
    }
}
#[derive(Debug, Default)]
pub struct ArchivedBlockBuilder {
    pub(crate) uncles: UncleBlockVec,
    pub(crate) transactions: TransactionVec,
    pub(crate) proposals: ProposalShortIdVec,
}
impl ArchivedBlockBuilder {
    pub const FIELD_COUNT: usize = 3;
    pub fn uncles(mut self, v: UncleBlockVec) -> Self {
        self.uncles = v;
        self
...
impl molecule::prelude::Builder for ArchivedBlockBuilder {
    type Entity = ArchivedBlock;
    const NAME: &'static str = "ArchivedBlockBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1)
            + self.uncles.as_slice().len()
            + self.transactions.as_slice().len()
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        ArchivedBlock::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
