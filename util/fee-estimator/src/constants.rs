...
/// Target blocks for default priority (lowest priority, about 2 hours).
pub(crate) const DEFAULT_TARGET: BlockNumber = MAX_TARGET;
/// Target blocks for low priority (about 1 hour).
pub(crate) const LOW_TARGET: BlockNumber = DEFAULT_TARGET / 2;
/// Target blocks for medium priority (about 10 minutes).
pub(crate) const MEDIUM_TARGET: BlockNumber = LOW_TARGET / 6;
