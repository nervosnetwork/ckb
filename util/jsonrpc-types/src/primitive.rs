...
///
/// This is a 64-bit unsigned integer type encoded as the 0x-prefixed hex string in JSON. See
/// examples of [Uint64](type.Uint64.html#examples).
...
/// The epoch indicator of a block. It shows which epoch the block is in, and the elapsed epoch
/// fraction after adding this block.
///
/// This is a 64-bit unsigned integer type encoded as the 0x-prefixed hex string in JSON. See
/// examples of [Uint64](type.Uint64.html#examples).
///
/// The lower 56 bits of the epoch field are split into 3 parts (listed in the order from higher
/// bits to lower bits):
///
...
/// 11000 and have 1000 blocks. The epoch field for this particular block will then be
/// 1,099,520,939,130,930, which is calculated in the following way:
///
/// ```text
/// 50 | ((11555 - 11000) << 24) | (1000 << 40)
/// ```
pub type EpochNumberWithFraction = Uint64;
/// The capacity of a cell is the value of the cell in Shannons. It is also the upper limit of the
/// cell occupied storage size where every 100,000,000 Shannons give 1-byte storage.
///
/// This is a 64-bit unsigned integer type encoded as the 0x-prefixed hex string in JSON. See
/// examples of [Uint64](type.Uint64.html#examples).
...
///
/// Based on the context, the weight is either the transaction virtual bytes or serialization size
/// in the block.
///
/// This is a 64-bit unsigned integer type encoded as the 0x-prefixed hex string in JSON. See
/// examples of [Uint64](type.Uint64.html#examples).
