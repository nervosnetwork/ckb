...
impl<T> ::core::iter::FromIterator<T> for BytesOptVec
where
    T: Into<BytesOpt>,
{
    fn from_iter<I: IntoIterator<Item = T>>(iter: I) -> Self {
...
impl<T> From<Vec<T>> for BytesOptVec
where
    T: Into<BytesOpt>,
{
    fn from(v: Vec<T>) -> Self {
...
impl<T> ::core::iter::FromIterator<T> for Byte32Vec
where
    T: Into<Byte32>,
{
    fn from_iter<I: IntoIterator<Item = T>>(iter: I) -> Self {
...
impl<T> From<Vec<T>> for Byte32Vec
where
    T: Into<Byte32>,
{
    fn from(v: Vec<T>) -> Self {
...
impl<T> ::core::iter::FromIterator<T> for UncleBlockVec
where
    T: Into<UncleBlock>,
{
    fn from_iter<I: IntoIterator<Item = T>>(iter: I) -> Self {
...
impl<T> From<Vec<T>> for UncleBlockVec
where
    T: Into<UncleBlock>,
{
    fn from(v: Vec<T>) -> Self {
...
impl<T> ::core::iter::FromIterator<T> for TransactionVec
where
    T: Into<Transaction>,
{
    fn from_iter<I: IntoIterator<Item = T>>(iter: I) -> Self {
...
impl<T> From<Vec<T>> for TransactionVec
where
    T: Into<Transaction>,
{
    fn from(v: Vec<T>) -> Self {
...
impl<T> ::core::iter::FromIterator<T> for ProposalShortIdVec
where
...
impl<T> From<Vec<T>> for ProposalShortIdVec
where
    T: Into<ProposalShortId>,
{
    fn from(v: Vec<T>) -> Self {
