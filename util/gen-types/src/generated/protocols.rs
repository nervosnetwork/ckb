...
impl ::core::iter::FromIterator<Node> for NodeVec {
...
impl ::core::iter::FromIterator<Node2> for Node2Vec {
    fn from_iter<T: IntoIterator<Item = Node2>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<Node2>> for Node2Vec {
    fn from(v: Vec<Node2>) -> Self {
        Self::new_builder().set(v).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<Address> for AddressVec {
    fn from_iter<T: IntoIterator<Item = Address>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<Address>> for AddressVec {
