...
#[derive(Clone)]
pub struct PenetrationMessage(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for PenetrationMessage {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for PenetrationMessage {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for PenetrationMessage {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}(", Self::NAME)?;
        self.to_enum().display_inner(f)?;
        write!(f, ")")
...
impl ::core::default::Default for PenetrationMessage {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        PenetrationMessage::new_unchecked(v)
    }
}
impl PenetrationMessage {
    ...
    pub fn to_enum(&self) -> PenetrationMessageUnion {
        let inner = self.0.slice(molecule::NUMBER_SIZE..);
        match self.item_id() {
    ...
    pub fn as_reader<'r>(&'r self) -> PenetrationMessageReader<'r> {
        PenetrationMessageReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for PenetrationMessage {
    type Builder = PenetrationMessageBuilder;
    const NAME: &'static str = "PenetrationMessage";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        PenetrationMessage(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        PenetrationMessageReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        PenetrationMessageReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
...
#[derive(Clone, Copy)]
pub struct PenetrationMessageReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for PenetrationMessageReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for PenetrationMessageReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for PenetrationMessageReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}(", Self::NAME)?;
        self.to_enum().display_inner(f)?;
        write!(f, ")")
...
impl<'r> PenetrationMessageReader<'r> {
    pub const ITEMS_COUNT: usize = 2;
    pub fn item_id(&self) -> molecule::Number {
        molecule::unpack_number(self.as_slice())
    }
    pub fn to_enum(&self) -> PenetrationMessageUnionReader<'r> {
        let inner = &self.as_slice()[molecule::NUMBER_SIZE..];
        match self.item_id() {
...
impl<'r> molecule::prelude::Reader<'r> for PenetrationMessageReader<'r> {
    type Entity = PenetrationMessage;
    const NAME: &'static str = "PenetrationMessageReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        PenetrationMessageReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
#[derive(Debug, Default)]
pub struct PenetrationMessageBuilder(pub(crate) PenetrationMessageUnion);
impl PenetrationMessageBuilder {
    pub const ITEMS_COUNT: usize = 2;
    pub fn set<I>(mut self, v: I) -> Self
    where
        I: ::core::convert::Into<PenetrationMessageUnion>,
    {
        self.0 = v.into();
        self
    }
}
impl molecule::prelude::Builder for PenetrationMessageBuilder {
    type Entity = PenetrationMessage;
    const NAME: &'static str = "PenetrationMessageBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE + self.0.as_slice().len()
    }
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        PenetrationMessage::new_unchecked(inner.into())
    }
}
#[derive(Debug, Clone)]
pub enum PenetrationMessageUnion {
    ConnectionRequest(ConnectionRequest),
    ConnectionRequestDelivered(ConnectionRequestDelivered),
}
#[derive(Debug, Clone, Copy)]
pub enum PenetrationMessageUnionReader<'r> {
    ConnectionRequest(ConnectionRequestReader<'r>),
    ConnectionRequestDelivered(ConnectionRequestDeliveredReader<'r>),
}
impl ::core::default::Default for PenetrationMessageUnion {
    fn default() -> Self {
        PenetrationMessageUnion::ConnectionRequest(::core::default::Default::default())
    }
}
impl ::core::fmt::Display for PenetrationMessageUnion {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            PenetrationMessageUnion::ConnectionRequest(ref item) => {
                write!(f, "{}::{}({})", Self::NAME, ConnectionRequest::NAME, item)
            }
            PenetrationMessageUnion::ConnectionRequestDelivered(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
...
impl<'r> ::core::fmt::Display for PenetrationMessageUnionReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            PenetrationMessageUnionReader::ConnectionRequest(ref item) => {
                write!(f, "{}::{}({})", Self::NAME, ConnectionRequest::NAME, item)
            }
            PenetrationMessageUnionReader::ConnectionRequestDelivered(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
...
impl PenetrationMessageUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            PenetrationMessageUnion::ConnectionRequest(ref item) => write!(f, "{}", item),
            PenetrationMessageUnion::ConnectionRequestDelivered(ref item) => write!(f, "{}", item),
        }
    }
}
impl<'r> PenetrationMessageUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            PenetrationMessageUnionReader::ConnectionRequest(ref item) => write!(f, "{}", item),
            PenetrationMessageUnionReader::ConnectionRequestDelivered(ref item) => {
                write!(f, "{}", item)
            }
        }
...
impl ::core::convert::From<ConnectionRequest> for PenetrationMessageUnion {
    fn from(item: ConnectionRequest) -> Self {
        PenetrationMessageUnion::ConnectionRequest(item)
    }
}
impl ::core::convert::From<ConnectionRequestDelivered> for PenetrationMessageUnion {
    fn from(item: ConnectionRequestDelivered) -> Self {
        PenetrationMessageUnion::ConnectionRequestDelivered(item)
    }
}
impl<'r> ::core::convert::From<ConnectionRequestReader<'r>> for PenetrationMessageUnionReader<'r> {
    fn from(item: ConnectionRequestReader<'r>) -> Self {
        PenetrationMessageUnionReader::ConnectionRequest(item)
    }
}
impl<'r> ::core::convert::From<ConnectionRequestDeliveredReader<'r>>
    for PenetrationMessageUnionReader<'r>
{
    fn from(item: ConnectionRequestDeliveredReader<'r>) -> Self {
        PenetrationMessageUnionReader::ConnectionRequestDelivered(item)
    }
}
impl PenetrationMessageUnion {
    pub const NAME: &'static str = "PenetrationMessageUnion";
    pub fn as_bytes(&self) -> molecule::bytes::Bytes {
        match self {
            PenetrationMessageUnion::ConnectionRequest(item) => item.as_bytes(),
            PenetrationMessageUnion::ConnectionRequestDelivered(item) => item.as_bytes(),
        }
    }
    pub fn as_slice(&self) -> &[u8] {
        match self {
            PenetrationMessageUnion::ConnectionRequest(item) => item.as_slice(),
            PenetrationMessageUnion::ConnectionRequestDelivered(item) => item.as_slice(),
        }
    }
    pub fn item_id(&self) -> molecule::Number {
        match self {
            PenetrationMessageUnion::ConnectionRequest(_) => 0,
            PenetrationMessageUnion::ConnectionRequestDelivered(_) => 1,
        }
    }
    pub fn item_name(&self) -> &str {
        match self {
            PenetrationMessageUnion::ConnectionRequest(_) => "ConnectionRequest",
            PenetrationMessageUnion::ConnectionRequestDelivered(_) => "ConnectionRequestDelivered",
        }
    }
    pub fn as_reader<'r>(&'r self) -> PenetrationMessageUnionReader<'r> {
        match self {
            PenetrationMessageUnion::ConnectionRequest(item) => item.as_reader().into(),
            PenetrationMessageUnion::ConnectionRequestDelivered(item) => item.as_reader().into(),
        }
    }
}
impl<'r> PenetrationMessageUnionReader<'r> {
    pub const NAME: &'r str = "PenetrationMessageUnionReader";
    pub fn as_slice(&self) -> &'r [u8] {
        match self {
            PenetrationMessageUnionReader::ConnectionRequest(item) => item.as_slice(),
            PenetrationMessageUnionReader::ConnectionRequestDelivered(item) => item.as_slice(),
        }
    }
    pub fn item_id(&self) -> molecule::Number {
        match self {
            PenetrationMessageUnionReader::ConnectionRequest(_) => 0,
            PenetrationMessageUnionReader::ConnectionRequestDelivered(_) => 1,
        }
    }
    pub fn item_name(&self) -> &str {
        match self {
            PenetrationMessageUnionReader::ConnectionRequest(_) => "ConnectionRequest",
            PenetrationMessageUnionReader::ConnectionRequestDelivered(_) => {
